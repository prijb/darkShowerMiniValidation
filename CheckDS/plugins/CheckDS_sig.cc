...
class CheckDS_sig : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
    public:
        explicit CheckDS_sig(const edm::ParameterSet&);
        ~CheckDS_sig();
...
//
CheckDS_sig::CheckDS_sig(const edm::ParameterSet& iConfig)
    :
...
// ------------ method called for each event  ------------
    void
CheckDS_sig::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    using namespace edm;
    ...
    outputTree->Fill();
        ...
        void
            CheckDS_sig::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
